...
local NOT_IMPLEMENTED = {
  ...
  'EntityCategoryFilterDown', 'EntityCategoryFilterOut', 'ExecLuaInSim', 'ExitApplication', 'ExitGame', 'FlushEvents',
  'FormatTime', 'GameTick', 'GameTime', 'GenerateBuildTemplateFromSelection', 'GetActiveBuildTemplate', 'GetAntiAliasingOptions',
  ...
  'GetFocusArmy', 'GetFrame', 'GetFrontEndData', 'GetGameSpeed', 'GetGameTime', 'GetGameTimeSeconds',
  ...
  'InternalCreateScrollbar', 'InternalCreateText', 'InternalCreateWldUIProvider', 'InternalCreateWorldMesh', 'InternalSaveGame', 'IsAlly',
  ...
  'LoadSavedGame', 'MapBorderAdd', 'MapBorderClear', 'OpenURL', 'ParseEntityCategory', 'PauseSound',
  ...
  'ToggleFireState', 'ToggleScriptBit', 'UISelectAndZoomTo', 'UISelectionByCategory', 'UIZoomTo', 'UnProject',

...
check(host.eval(`return (pcall(function() __units[${acu}]:HideBone(-1, true) end))`) === false, 'the pseudo bone -1 is the engine error too (HideBone resolves with 0, so the minimum is 0 -- Cfile:936295, 981522)')
